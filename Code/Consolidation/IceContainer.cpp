...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *	A method to call a given callback for each element of the container.
 *	\param		proc		[in] the standard callback
 *	\param		param		[in] a user-defined parameter passed to the callback
 *	\param		context		[in] a user-defined context passed to the callback
 *	\return		true if success
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool Container::Foreach(ENUMERATION proc, udword param, udword context)
{
	if(!proc)	return false;

	for(udword i=0;i<mCurNbEntries;i++)
	{
		bool Status = (*proc)(mEntries[i], param, context);
		if(!Status)	{ SetIceErrorMsg("Enumeration has failed"); return false; }
	}
	return true;
}
